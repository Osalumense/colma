	...
	<body>
		<div class="card">
			<div class="card-head style-primary">
				<header>Cash-in Savings</header>
			</div>
			<div class="card-body">
				<form class="form form-validate floating-label" method = 'post' action ='individualsavingsreg.php' id = 'cashinrepayment' novalidate="novalidate">
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<label for="setoffdate">Receipt Date</label>
							</div>
						</div>
					</div>
					<div class="form-group">
			...
			<div class="card-actionbar">
				<div class="card-actionbar-row">
					<button type="submit"  name = "individualsavings" class="btn btn-flat btn-default ink-reaction">Save</button>
				</div>
		...
		<script src="../assets/js/individualsavings.js"></script>
		<!-- END JAVASCRIPT -->
	</body>
</html>