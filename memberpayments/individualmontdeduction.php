...
<html lang="en">
	<head>
		<title>Enter Monthly Deduction - Individual</title>
	...
	<body>
			...
			<div class="col-lg-12">
				<div class="card">
					<div class="card-head style-primary">
						<header>Enter Monthly Deduction - Individual</header>
					...
					<div class="card-body ">
						<form class="form form-validate floating-label" id = 'searchform' novalidate="novalidate">
							<div class="row">
								...
								<div class="col-sm-12">
									<button type="submit" id = 'updatememdeduct' name = 'updatememdeduct' class = "btn btn-primary ink-reaction" disabled>Update</button>
								</div>
				...
				<div class="modal-dialog card">
					<div class="modal-content">
						<div class="card-body" id = 'card-body'>
							...
							<div class="modal-footer card-actionbar" hidden>
		...
		<script src="../assets/js/individualmontdistribution.js"></script>
		<!-- END JAVASCRIPT -->
	</body>
</html>