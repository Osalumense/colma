	...
	<body class="menubar-hoverable header-fixed">
		...
		<div class="card">
			...
			<div class="card-head style-primary">
				<header>View Monthly Deductions</header>
			</div><br>
			<div class="card-body">
				...
				<br>
				<div class="row">
					<button class="btn btn-default" id="export_tbl">Export to Excel</button>
				</div>
		...
		<script src="../assets/js/viewdeductions.js"></script>
		<!-- <script src="../assets/FileSaverjs/FileSaver.js"></script> 
		<script src="../assets/TableExport/dist/js/tableexport.js"></script> -->
