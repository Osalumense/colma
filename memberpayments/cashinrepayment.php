	...
	<body>
		<div class="card">
			<div class="card-head style-primary">
				<header>Cash-in: Balloon Repayment</header>
			</div>
			<div class="card-body">
				<form class="form form-validate floating-label" method = 'post' action ='cashinrepaymentreg.php' id = 'cashinrepayment' novalidate="novalidate">
			...
			<div class="card-actionbar">
				<div class="card-actionbar-row">
					<button type="submit" name = 'cashinrepayment' id = "createform" class="btn btn-flat btn-default ink-reaction">Save</button>
				</div>
