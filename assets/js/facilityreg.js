$(document).ready(function(){
    ...
    //Check for duplicate names while typing membername
    $('#membername').on('keyup', function() {
        getmember('membername', 'memid');
        let member = $(this).val();
        let g1 = $('#guarantor1').val();
        let g2 = $('#guarantor2').val();
        let witness = $('#witness').val();

        if((member == g1) || (member == g2) || (member == witness)) {
            $(this).val('');
        }
    });
    ...
    $('#guarantor1').on('keyup', function() {
        ...
        let g1 = $(this).val();
        let g2 = $('#guarantor2').val();
        let member = $('#membername').val();
        let witness = $('#witness').val();

        if((g1 == g2) || (g1 == member) || (g1 == witness)) {
            $(this).val('');
        }
    });
    ...
    $('#witness').on('keyup', function () {
        ...
        if((witness == g1) || (witness == g2) || (witness == member) ) {
            $(this).val('');
        }
    });
