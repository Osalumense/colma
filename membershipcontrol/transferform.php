		...
		<form class="form form-validate floating-label" novalidate="novalidate">
			<div class="card">
				<div class="card-head style-primary">
					<header>INDIVIDUAL TRANFER FORM</header>
				</div>
				<div class="card-body">
					<div class="row">
						<div class="col-sm-8">
							<div class="form-group">
								...
								<label for = "accname1">Account Name</label>
								<input type="hidden" id="memid1" name="memid1">
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
								<input type = "text" class = "form-control" id = "accno1" name = "accno1" required data-rule-minlength="2" disabled/>
								<label for="accno1">Account Number</label>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								<select id="grpname" name="grpname" class="form-control" required>
					...
					<fieldset>
						...
						<div class="row">
							...
							<div class="col-sm-4">
								<div class="form-group">
									<input type="text" id = 'accno2' name = 'accno2' class="form-control" required data-rule-minlength="2" disabled>
				...
				<div class="card-actionbar">
					<div class="card-actionbar-row">
						<button type="submit" class="btn btn-flat btn-default ink-reaction " id="submit_transfer">Validate</button>
					</div>
