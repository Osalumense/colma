	...
	<body>
		<div class="card">
			<div class="card-head style-primary">
				<header>Cashout Savings Withdrawal</header>
			</div>
			<div class="card-body">
				<form class="form form-validate floating-label" method = 'post' action ='cashoutsavingsreg.php' id = 'cashinrepayment' novalidate="novalidate">
					...
					<div class="form-group">
						...
						<label for = 'payer'>Receiver </label>	
					</div>
					<div class="row">
						<div class="col-sm-8">
							<div class="form-group">
					...
					<div class="row">
						<div class="col-sm-8">
							<div class="form-group">
								<textarea class="form-control" id="remark" name="remark" required data-rule-minlength="2"> </textarea>
			...
			<div class="card-actionbar">
				<div class="card-actionbar-row">
					<button type="submit" name = 'cashoutsavingsreg' id = "createform" class="btn btn-flat btn-default ink-reaction">Save</button>
				</div>
		...
		<script src="../assets/js/cashoutsavings.js"></script>
		<!-- END JAVASCRIPT -->
	</body>
</html>