	...
	<body>
		<div class="card">
			<div class="card-head style-primary">
				<header>Cash-out: Refund Loans</header>
			</div>
			<div class="card-body">
				<form class="form form-validate floating-label" method = 'post' action ='cashoutrefundloansreg.php' id = 'cashinrepayment' novalidate="novalidate">
			...
			<div class="card-actionbar">
				<div class="card-actionbar-row">
					<button type="submit" name = 'cashoutrefundloans' id = "cashoutrefundloans" class="btn btn-flat btn-default ink-reaction">Save</button>
				</div>
		...
		<script src="../assets/js/cashoutrefundloans.js"></script>
		<!-- END JAVASCRIPT -->
	</body>
</html>