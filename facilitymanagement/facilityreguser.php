...
<html lang="en">
	...
	<body>
			...
			<div class="col-lg-12">
				<div class="card">
					<div class="card-head style-primary">
						<header>Apply For A Facility - User</header>
							...
							<form class="form floating-label" id="application-form">
							   ...
							   <div class = "tab-content clearfix">
							   		<div class = "tab-pane active" id="step1">
                                        <div class="row">
                                        <input type="text" id="memid" value="<?=$userid?>" hidden>
											<div class = "col-sm-5">
                                                <div class="form-group">
                                                    <input type="text" id = 'loanamount' name = 'loanamount' class = "form-field form-control number" data-rule-minlength="2" required>
										...
										<div class="row">
											...
											<div class="col-sm-4">
												<div class="form-group">
                                                    <input type="number" id = 'periodinmnths' name = 'periodinmnths' class = "form-field form-control" data-rule-minlength="2" required>
										...
										<div class="row">
											<div class="col-sm-5">
												<div class="form-group">
                                                    <input type="text" id = 'guarantor1' name = 'guarantor1'class="form-control">
                                                    <label for="guarantor1" class="control-label" required>Enter Guarantor 1</label>
								...
								<ul class = "pager wizard">
									<li class = "previous first"><a class = "btn-raised move" href="javascript:void(0);">First</a></li>
									<li class = "previous"><a class = "btn-raised move" href="javascript:void(0);">Previous</a></li>
									<li class = "next last"><a class = "btn-raised move" href="javascript:void(0);">Last</a></li>
									<li class="next"><a class="btn-raised move" href="javascript:void(0);">Next</a></li>
								</ul>
		...
		<script src="../assets/js/facilityreguser.js"></script> 
		<!-- END JAVASCRIPT -->
	</body>
</html>