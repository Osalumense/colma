...
<html lang="en">
	...
	<body>
		<div class="card">
			...
			<div class="card-body">
				...
				<div id="rootwizard2" class="form-wizard form-wizard-horizontal">
					<form class="form floating-label form-validation" role="form" novalidate="novalidate" method = 'post' action = 'addliberatorreg.php'>
						<div class="form-wizard-nav">
							<div class="progress"><div class="progress-bar progress-bar-primary"></div></div>
							<ul class="nav nav-justified">
								<li class="active"><a href="#step1" data-toggle="tab"><span class="step">1</span> <span class="title">Add Liberator</span></a></li>
							</ul>
						</div>
						<div class="tab-content clearfix">
							<div class="tab-pane active" id="step1">
								...
								<div class="row">
									<div class="col-sm-4">
										<div class="form-group">
											<input type = "text" class = "form-control form-field" id = "staffid" name = "staffid" required data-rule-minlength="2" />
											<label for="staffid">Staff ID</label>
										</div>
									</div>
									<div class = "col-sm-4">
										<div class = "form-group">
											<select name="post" id="post" class = "form-field form-control selectbox" required>
											</select>
								...
								<div class="row">
									<div class = "col-sm-4">
										<div class = "form-group">
											<select name="duty" id="duty" class = "form-field form-control selectbox" required>											
											</select>
			...
			<div class="card-actionbar">
				...
				<button type="submit" name = 'addliberatorreg' class="btn btn-primary">SAVE</button>
				</div>
			</div>
		</div><!--end .card -->
		</form>
		...
		<script src="../assets/js/addliberator.js"></script>
		<!-- END JAVASCRIPT -->
	</body>
</html>